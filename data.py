...
def consulta_auto_avaliar(placa,empresa):
    ...
    headers = {
        'Content-Type': 'application/json',  # Tipo de conteúdo
        "token": "eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9..JkzROHmXJTSr-8RrtM6aTSMQzIeTYDOh_xGxsKnLW8Q",  # Cabeçalho de autorização, se necessário
